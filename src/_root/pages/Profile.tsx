...
const StatBlock = ({ value, label }: StatBlockProps) => (
  <div className="flex-center flex-col gap-1">
    <p className="small-semibold lg:body-bold text-dark-4">{value}</p>
    <p className="small-light lg:base-light text-dark-4">{label}</p>
  </div>
)
      ...
      <div className="profile-inner_container">
        <div className="flex xl:flex-row flex-col max-xl:items-center flex-1 gap-7">
          <img
            ...
            alt="profile"
            className="w-28 h-28 lg:h-36 lg:w-36 rounded-full mt-2"
          />
          <div className="flex flex-col flex-1 justify-between md:mt-2">
            <div className="flex flex-col w-full">
              ...
              <p className="small-regular md:body-medium text-dark-5 text-center xl:text-left">
          ...
          <div className="flex justify-center gap-4">
            <div className={`${user.id !== currentUser.$id && 'hidden'}`}>
              <Link
                ...
                className={`h-12 bg-light-2 px-5 pl-4 text-dark-4 flex-center gap-2 rounded-lg ${
